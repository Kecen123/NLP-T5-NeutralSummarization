...
from transformers import MBartTokenizer, T5ForConditionalGeneration, BartForConditionalGenerationAndClassification
...
class SummarizationModule(BaseTransformer):
    ...
    def __init__(self, hparams, **kwargs):
        ...
        if self.model.config.decoder_start_token_id is None and isinstance(self.tokenizer, T5Tokenizer):
    ...
    def _step(self, batch: dict) -> Tuple: # 1
        ...
        if isinstance(self.model, BartForConditionalGenerationAndClassification):
